...
bool Companion::checkBleEnabled() const
{
    QVariantMap result;
...
QVariantMap Companion::callReport() const
{
    QVariantMap result;
...
QList<QVariantMap> Companion::getReports(int limit) const
{
...
QVariantMap Companion::manufacturerForId(int id)
{
